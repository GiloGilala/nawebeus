...
| Product — Module 3 Social integration | 🟡 core (was 🔴 none; NWB-P2-001, 2026-09-24: OAuth flow — single-use state/PKCE, AES-256-GCM token sealing, schema adopted 0011) | Remaining: token refresh worker (P2-002), health + breaker (P2-003), quota (P2-004), the five API adapters (P2-005), management routes (P2-006) | Entire phase | `db/social-accounts/` (4 tbls, adopted 0011) | P1 queue | **Required** | Phase 3 |
