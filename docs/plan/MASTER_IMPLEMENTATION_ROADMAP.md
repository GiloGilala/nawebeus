...
| 02 | [02-defects.md](master-roadmap/02-defects.md) | §5 | Defect register — 13 defects verified in the working tree 2026-09-20 (F-01…F-19) + CASL v7 semantic verification |
...
| 1 | Foundation completion + defect remediation | 🔴 not started | NWB-P0-010…023 (new) + NWB-P0-002, NWB-P0-005 (open plan tickets) | Phase 0 | **D12, D13, D11, D15** (decide in-phase) | §4, §5 (13 defects), §11 | §11 exit criteria (1–7): E2E owner→invite→accept demo; migrations from zero; DSAR; 0 Critical/High open |
