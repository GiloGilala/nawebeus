...
| 2 | Shared infrastructure (P1) | 🟨 in progress — **NWB-P1-001 (queue + scheduler + worker base) DONE 2026-09-21**, 48 queue tests, `bun test` 502/0, backlog ticket book at `.scratch/p1-shared-infra/` | NWB-P1-001 ✅, NWB-P1-002…012; new: **NWB-P1-013** (purge batching, found by P1-001) | Phase 1; **D6** | Resend/R2 credentials | plan §5 P1; §12, §12.1 | §12 exit gate: worker loop ✅, purge/reclamation scheduled ✅, real email, approval queue, media, flags, observability |
