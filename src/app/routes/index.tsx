  ...
  return (
    <main style={{ padding: "2rem", fontFamily: "sans-serif" }}>
      ...
      <p style={{ color: "#666", fontSize: "0.9rem" }}>
        Architecture: TanStack Start (SSR + Server Functions) + Hono at <code>/api/*</code> — single
        Bun process (ADR-002, ADR-007). Web calls <code>services/</code> in-process; mobile &
        webhooks use Hono.
      </p>
