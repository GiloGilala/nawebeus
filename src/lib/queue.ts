...
export const QUEUE_JOBS = {
  ...
  /** NWB-P2-003 — five-minute health probes with the circuit breaker + chronic escalation. */
  socialHealthCheck: "socialaccounts.health-check",
